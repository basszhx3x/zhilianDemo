...
-(void)jobOperation:(UIButton *)sender
{
    switch (sender.tag)
    {
        ...
        case 5000:
        {
            ...
            UIActivityIndicatorView *activityInView= [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:(UIActivityIndicatorViewStyleGray)];
            activityInView.frame = CGRectMake((320-30)/2, (400-30)/2, 30, 30);
            [activityInView startAnimating];
            UIView *blackView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 480)];
            blackView.backgroundColor = [UIColor blackColor];
            blackView.alpha = 0.4;
            
            UIView *frontView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 480)];
            frontView.backgroundColor = [UIColor clearColor];
            [frontView addSubview:activityInView];
            
            [blackView addSubview:frontView];
            
            [self.view addSubview: blackView ];
            [activityInView release];
