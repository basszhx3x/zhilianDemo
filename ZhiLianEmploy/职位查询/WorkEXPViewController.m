...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self)
    {
        ...
        self.indes = [[NSIndexPath alloc] init];
...
-(void)workExp
{
    ...
    NSMutableDictionary *workEXPDic = [NSMutableDictionary dictionary];
    workEXPDic = [basedataDic valueForKey:@"workEXP"];
    NSMutableArray *ItemArr = [NSMutableArray array];
    ItemArr = [workEXPDic valueForKey:@"item"];
